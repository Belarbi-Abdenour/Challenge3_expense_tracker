    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li >
                    <a href="subusers.php"><i class="fas fa-calendar-day"></i> <span>Sub_users</span></a>
                </li>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "UPDATE category SET name='$description' WHERE id='$getid'";
         ...
         <div class="page-wrapper">
            ...
            <body>
              ...
              <form method="POST">
                ...
                <input type="text" name="description" id="description" value="<?php echo $row['name']; ?>"><br>
