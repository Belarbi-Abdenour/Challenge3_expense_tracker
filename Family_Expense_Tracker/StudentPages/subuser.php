...
<br>
        ...
        $sql = "SELECT * FROM subuser where  user_id = $userid ";//$_SESSION["user_id"]
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Subuser</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item active">subusers</li>
                            </ul>
                        </div>
                        <div class="col-auto text-right float-right ml-auto">
                            <a href="add_subuser.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                        </div>
  ...
  while($row = mysqli_fetch_assoc($result)) {
   if($row["is_active"] == 1){$status = "active";}else{$status = "blocked";}
   echo '<tr>
            <td>' . $row["name"] . '</td>
            <td>' . $row["email"] . '</td>
            <td>' . $status . '</td>
            <td class="text-right">
              <a href="edit_subuser.php?id=' . $row["id"] . '" class="btn btn-sm bg-success-light mr-2">
              <i class="fas fa-pen"></i></a> |  
              <a href="del_subuser.php?id=' . $row["id"] . '" class="btn btn-sm bg-danger-light"><i class="fas fa-trash"></i></a>
            </td>
          </tr>';
  }
