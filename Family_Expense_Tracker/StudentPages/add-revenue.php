...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO revenue (id,description, amount, category_id,user_id) VALUES ('','$description', '$amount', '$category_id',$userid)";
         ...
         <div class="page-wrapper">
            ...
            <body>
              ...
              <form method="POST">
                ...
                <input type="text" name="category_id" id="category_id" placeholder="Category"><br>
