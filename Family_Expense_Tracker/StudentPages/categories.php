...
<br>
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo '<tr>
            <td>' . $row["name"] . '</td>
            <td class="text-right">
              <a href="edit-category.php?id=' . $row["id"] . '" class="btn btn-sm bg-success-light mr-2">
              <i class="fas fa-pen"></i></a>| 

              <a href="delete-category.php?id=' . $row["id"] . '" class="btn btn-sm bg-danger-light"><i class="fas fa-trash"></i></a>
            </td>
          </tr>';
  }
