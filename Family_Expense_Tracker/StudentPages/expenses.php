...
<br>
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto text-right float-right ml-auto">
                            <a href="add-expenses.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                        </div>
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo '<tr>
            ...
            <td class="text-right">
              <a href="edit-expense.php?id=' . $row["id"] . '" class="btn btn-sm bg-success-light mr-2">
              <i class="fas fa-pen"></i></a>| 

              <a href="delete-expense.php?id=' . $row["id"] . '" class="btn btn-sm bg-danger-light"><i class="fas fa-trash"></i></a>
            </td>
          </tr>';
  }
